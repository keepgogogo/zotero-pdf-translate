...
export type FluentMessageId =
  ...
  | 'service-zhipuai'
  | 'service-zhipuai-dialog-endPoint'
  | 'service-zhipuai-dialog-maxTokens'
  | 'service-zhipuai-dialog-model'
  | 'service-zhipuai-dialog-prompt'
  | 'service-zhipuai-dialog-stream'
  | 'service-zhipuai-dialog-temperature'
  | 'sideBarIcon-title'
  | 'status-translating'
  | 'swapLanguage'
  | 'translate';
